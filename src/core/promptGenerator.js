...
function buildLessonResultTemplate({ projectId, moduleId, topic }) {
  return {
    ...
    durationMin: 16,
    timeSpentMin: 16,
    resultAddedAt: "YYYY-MM-DDTHH:mm:ss.sssZ",
    aiSource: {
      name: "<ai-name-or-model>",
      company: "<ai-company>",
    },
    moduleId,
    topic,
...
export function renderNextLessonPrompt(packet) {
  ...
  return [
    ...
    "- Set aiSource with your own AI/model name and company/provider.",
    "- Set timeSpentMin to the user's actual time spent in this lesson.",
    "- Set resultAddedAt to the timestamp when this LessonResultData is produced.",
